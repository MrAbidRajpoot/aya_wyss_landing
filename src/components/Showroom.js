...
function Showroom() {
  return (
    <section id='showroom' className='mt-32 mb-[700px] flex justify-center'>
      <div className=' w-[584px] bg-[#EDF2F7] h-[247px] absolute'>
        <div className='w-[450px] bg-[#667EEA] h-[507px] absolute mt-6 ml-20 drop-shadow-xl'>
          <div className='bg-[#FFF9F0] w-[450px] h-[507px] -m-3 pt-6 drop-shadow-xl'>
          <div class="container flex justify-center items-center">
            <img src={logo} alt='Logo' className='w-[73px] h-[50px]'></img>
          </div>
            <h1 className='text-4xl font-bold text-[#667EEA] text-center'>Showroom</h1>
            <h1 className='text-center text-xl text-[#4A5568]'>Login to view showroom</h1>
            <div className='mt-10 flex justify-center'>
            <form class="space-y-10 w-full px-8">
            <div class="relative bg-[#EDF2F7] border-b-2 border-[#667EEA80]">
              <input type="text" name="username" placeholder=" " class="block p-2 w-full focus:outline-none text-lg appearance-none bg-transparent" />
              <label for="username" className="absolute top-0 p-2 text-lg duration-300  origin-0 flex flex-row items-center gap-2 ">
            ...
            <div class="relative bg-[#EDF2F7] border-b-2 border-[#667EEA80] ">
              ...
              <label for="password" className="absolute top-0 text-lg p-2 duration-300 origin-0 flex flex-row items-center  gap-2 ">
              ...
              <div>
                <button className='w-full bg-[#667EEA] text-white font-medium p-3 px-8 flex justify-center'>
                Login
                </button>
              </div>
            </form>
