...
function HeroComponent() {
  return (
    <div className='md:flex md:flex-row justify-between md:gap-40 my-10 mx-24 relative z-10'>
      ...
      <div className='md:w-1/2 relative mt-20 md:mt-0 flex justify-center md:block'>
          <img src={dots} className='absolute hidden md:block -mt-10 -ml-7 z-0 ' alt="Background Image 1" />
          <img src={dots} className='absolute hidden md:block md:mt-20 md:left-24 lg:mt-60 lg:left-52 z-0'></img>
